...
extension GetCategoryDbCollection on Isar {
  IsarCollection<CategoryDb> get category => this.collection();
}
...
const CategoryDbSchema = CollectionSchema(
  ...
  properties: {
    r'color': PropertySchema(
      ...
      name: r'color',
      type: IsarType.byte,
      enumMap: _CategoryDbcolorEnumValueMap,
    ),
...
const _CategoryDbcolorValueEnumMap = {
  ...
  1: CategoryColor.red,
  2: CategoryColor.orange,
  3: CategoryColor.deepOrange,
  4: CategoryColor.amber,
  5: CategoryColor.yellow,
  6: CategoryColor.lime,
  7: CategoryColor.lightGreen,
  8: CategoryColor.green,
  9: CategoryColor.teal,
  10: CategoryColor.cyan,
  11: CategoryColor.lightBlue,
  12: CategoryColor.blue,
  13: CategoryColor.indigo,
  14: CategoryColor.purple,
  15: CategoryColor.deepPurple,
  16: CategoryColor.blueGrey,
  17: CategoryColor.brown,
  18: CategoryColor.grey,
};
...
extension CategoryDbByIndex on IsarCollection<CategoryDb> {
  ...
  CategoryDb? getByIdSync(String id) {
  ...
  Future<List<CategoryDb?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<CategoryDb?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(CategoryDb object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(CategoryDb object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<CategoryDb> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<CategoryDb> objects, {bool saveLinks = true}) {
...
extension CategoryDbQueryWhereSort
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhere> anyIsarId() {
...
extension CategoryDbQueryWhere
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> isarIdLessThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> idEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterWhereClause> idNotEqualTo(
      String id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension CategoryDbQueryFilter
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterFilterCondition> isarIdEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterFilterCondition> isarIdGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterFilterCondition> isarIdLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterFilterCondition> isarIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CategoryDbQuerySortBy
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<CategoryDb, CategoryDb, QAfterSortBy> sortByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryDbQuerySortThenBy
  ...
  QueryBuilder<CategoryDb, CategoryDb, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<CategoryDb, CategoryDb, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryDbQueryProperty
  ...
  QueryBuilder<CategoryDb, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isarId');
    });
  }

  QueryBuilder<CategoryDb, CategoryColor, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
